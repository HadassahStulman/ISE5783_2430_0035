...
public class LightsTests {
   ...
   public void trianglesMultipleLights() {
      scene2.geometries.add(triangle1, triangle2);
      scene2.lights.add(new SpotLight(new Color(0, 255, 100), new Point(10,20,-90), new Vector(-3,-3, -3))
                      .setKl(0.000000001).setKq(0.0000001));
      scene2.lights.add(new PointLight(new Color(0, 0, 255), new Point(-10, 50, -10))
                      .setKl(0.00003).setKc(1.00001).setKq(0.000001));
      scene2.lights.add(new DirectionalLight(new Color(255, 0, 0), new Vector(-5,-5,-5)));
   ...
   public void sphereMultipleLights() {
      ...
      scene2.lights.add(new SpotLight(new Color(100, 255, 100), new Point(-60,-60,40), new Vector(1,1, -3))
              .setKl(0.000000001).setKq(0.0000001));
      scene2.lights.add(new PointLight(new Color(ORANGE).reduce(2), new Point(-10, 50, -10))
              .setKl(0.00003).setKc(1.00001).setKq(0.000001));
      scene2.lights.add(new DirectionalLight(new Color(255, 0, 0), new Vector(-5,-5,-5)));
